	...
	{				
		...
		try{
			...
			{					
				...
				String isGreen="None",Extras="None",comparisonSiteExclusive="False",savePerYear="None";
		...
		try				
		{
			...
			for (WebElement comparisonelementfromlist : comparisonlist)
			{
				...
				default:
					...
					{
						variable_value = temp+" AND "+variable_value;
						update=true;
					}
					temp = variable_value ;
			...
			if(hasGas)
			{
				...
				for (WebElement comparisonelementfromlist : gas_comparisonlist)
				{
					...
					default:
						...
						{
							gas_variable_value = gas_temp+" AND "+gas_variable_value;
							gas_update=true;
						}
