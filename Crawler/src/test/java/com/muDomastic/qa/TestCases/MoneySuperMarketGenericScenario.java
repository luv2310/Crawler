...
import com.muDomastic.qa.page.MoneySuperMarketPage;
import com.muDomastic.qa.util.TestUtil;


public class MoneySuperMarketGenericScenario extends TestBase {
	...
	public  MoneySuperMarketGenericScenario() {
	...
	public void executevalue() 
	{
		...
		{
			System.out.println(":: Exception occured in Class MoneySuperMarketGenericScenario, method name  execute value :: " );
			e.printStackTrace();
		}
	}
	...
	public void closeTest()
	{
		try {		 
			...
			String filepath = System.getProperty("user.dir")+"\\MoneySuperMarket_data.yaml";
	...
	public void runCrawler() {
		try{
			//running the crawler for MoneySuperMarket website
			MoneySuperMarketPage MoneySuperMarketPageObj=new MoneySuperMarketPage();
			MoneySuperMarketPageObj.MoneySuperMarketJourney(
					postCode,
					partialAddress,
					supplierName,
					paymentMethod,
			...
			HashMap<String, Map> sectionData = MoneySuperMarketPageObj.storedataNew(hasGas,paymentMethod);	
			...
			if(sectionData.isEmpty())
			{
				...
				File DestFile=new File(System.getProperty("user.dir")+"\\screenShotResults\\MoneySuperMarket_"+requestId+"_requestID_"+attempt+"_attemptLeft_"+time+".png");
	...
	public void crawlerReAttempt() 
	{
		try {
			...
			System.out.println(":: Exception occured in crawlerReAttempt method of MoneySuperMarketGenericScenario  :: "); 
			e.printStackTrace();
		}	
	}
	...
	public void driverClose() 
	{
		...
		} catch (Exception e) {	System.out.println(":: Exception occured in driverClose method of MoneySuperMarketGenericScenario  :: "); 
		e.printStackTrace();
		}
	}
