...
public class goCompareGenericScenario extends TestBase {
	...
	public void runCrawler() {
		try{
			...
			HashMap<String, Map> sectionData = goComparePageObj.storedataNew(hasGas,isEconomy7);	
			...
			if(sectionData.isEmpty())
			{
				...
				File DestFile=new File(System.getProperty("user.dir")+"\\screenShotResults\\goCompare_"+requestId+"_requestID_"+attempt+"_attemptLeft_"+time+".png");
