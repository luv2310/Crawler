...
import com.muDomastic.qa.page.EnergyLinxPage;
import com.muDomastic.qa.util.TestUtil;


public class EnergyLinxGenericScenario extends TestBase {
	...
	public  EnergyLinxGenericScenario() {
	...
	public void executevalue() 
	{
		...
		{
			System.out.println(":: Exception occured in Class energyLinxGenericScenario, method name  execute value :: " );
			e.printStackTrace();
		}
	}
	...
	public void closeTest()
	{
		try {		 
			...
			String filepath = System.getProperty("user.dir")+"\\energyLinx_data.yaml";
			...
			System.out.println("Exception occured while running the closeTest method of class energyLinxGenericScenario ");
		}
	}

	public void runCrawler() {
		try{
			//running the crawler for energyLinx website
			EnergyLinxPage energyLinxPageObj =new EnergyLinxPage();
			energyLinxPageObj.energyLinxJourney(
					postCode,
					partialAddress,
					supplierName,
					paymentMethod,
			...
			HashMap<String, Map> sectionData = energyLinxPageObj.storedataNew(hasGas,paymentMethod);	
			...
			if(sectionData.isEmpty())
			{
				...
				File DestFile=new File(System.getProperty("user.dir")+"\\screenShotResults\\energyLinx_"+requestId+"_requestID_"+attempt+"_attemptLeft_"+time+".png");
			...
			System.out.println("Exception occured in runCrawler method of energyLinxGenericScenario  :: "+ e);
		}
	}
	public void crawlerReAttempt() 
	{
		try {
			...
			System.out.println(":: Exception occured in crawlerReAttempt method of energyLinxGenericScenario  :: "); 
			e.printStackTrace();
		}	
	}
	...
	public void driverClose() 
	{
		...
		} catch (Exception e) {	System.out.println(":: Exception occured in driverClose method of energyLinxGenericScenario  :: "); 
		e.printStackTrace();
		}
	}
