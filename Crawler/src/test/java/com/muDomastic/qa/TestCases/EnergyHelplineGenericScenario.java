...
import com.muDomastic.qa.page.EnergyHelplinePage;
import com.muDomastic.qa.util.TestUtil;


public class EnergyHelplineGenericScenario extends TestBase {
	...
	public  EnergyHelplineGenericScenario() {
	...
	public void executevalue() 
	{
		...
		{
			System.out.println(":: Exception occured in Class energyHelplineGenericScenario, method name  execute value :: " );
			e.printStackTrace();
		}
	}
	...
	public void closeTest()
	{
		try {		 
			...
			String filepath = System.getProperty("user.dir")+"\\energyHelpline_data.yaml";
			...
			System.out.println("Exception occured while running the closeTest method of class energyHelplineGenericScenario ");
		}
	}

	public void runCrawler() {
		try{
			//running the crawler for energyHelpline website
			EnergyHelplinePage energyHelplinePageObj =new EnergyHelplinePage();
			energyHelplinePageObj.energyHelplineJourney(
					postCode,
					partialAddress,
					supplierName,
					paymentMethod,
			...
			HashMap<String, Map> sectionData = energyHelplinePageObj.storedataNew(hasGas,paymentMethod);	
			...
			if(sectionData.isEmpty())
			{
				...
				File DestFile=new File(System.getProperty("user.dir")+"\\screenShotResults\\energyHelpline_"+requestId+"_requestID_"+attempt+"_attemptLeft_"+time+".png");
			...
			System.out.println("Exception occured in runCrawler method of energyHelplineGenericScenario  :: "+ e);
		}
	}
	public void crawlerReAttempt() 
	{
		try {
			...
			System.out.println(":: Exception occured in crawlerReAttempt method of energyHelplineGenericScenario  :: "); 
			e.printStackTrace();
		}	
	}
	...
	public void driverClose() 
	{
		...
		} catch (Exception e) {	System.out.println(":: Exception occured in driverClose method of energyHelplineGenericScenario  :: "); 
		e.printStackTrace();
		}
	}
